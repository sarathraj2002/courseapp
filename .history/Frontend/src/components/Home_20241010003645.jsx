...
const Home = () => {
  const courses=[
    ...
    },
    {
     ...
     Discription:"he process of examining, cleaning, transforming, and modeling data with the goal of discovering useful information, drawing conclusions, and supporting decision-making",
     Fees:"25000"
    },
    {
    courseId:"CS103",
